...
var style_Suvinisu_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_Suvinisu_16_eval_expression(context) !== null) {
        labelText = String(exp_label_Suvinisu_16_eval_expression(context));
    }
