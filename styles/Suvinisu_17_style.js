...
var style_Suvinisu_17 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_Suvinisu_17_eval_expression(context) !== null) {
        labelText = String(exp_label_Suvinisu_17_eval_expression(context));
    }
