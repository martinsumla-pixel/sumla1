...
function exp_label_Talioder2026_7_eval_expression(context) {
    // pollunr + '\n' + pindala

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('pollunr')  + '\n') + feature.get('pindala') );
    } else {
        return ((feature.get('pollunr')  + '\n') + feature.get('pindala') );
    }
}
...
function exp_label_TalioderFIE_8_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_Polduba_9_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_Taliraps_10_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_Hernes_11_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_Suvioder_12_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_Talinisu_13_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_SuvioderFIE_14_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_TalinisuFIE_15_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_Suvinisu_16_eval_expression(context) {
    // pollunr + '\n' + pindala
...
function exp_label_Suvinisu_17_eval_expression(context) {
    // pollunr + '\n' + pindala
